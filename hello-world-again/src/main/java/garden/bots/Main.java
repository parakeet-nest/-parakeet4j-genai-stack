...
public class Main {
    ...
    public static void chatCompletion(String llmBaseUrl, String model,Options options, String userContent, String systemContent) {
        ...
        */
        ...
        var resultAnswer = ChatStream(llmBaseUrl, queryChat,
                chunk -> {
                    System.out.print(chunk.getMessage().getContent());
                    return null;
                });
        ...
        if(resultAnswer.exception().isEmpty()) {
            System.out.println();
            System.out.println("Completion complete: " + resultAnswer.getAnswer().getMessage().getContent());
        } else {
            System.out.println("Error: " + resultAnswer.exception().toString());
        }
    }
